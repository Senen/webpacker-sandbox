  ...
  class ListItemsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @list_item.save
          format.html { redirect_to [:stimulus, @list_item], notice: 'List item was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @list_item.update(list_item_params)
          format.html { redirect_to [:stimulus, @list_item], notice: 'List item was successfully updated.' }
    ...
    def destroy
      @list_item.destroy
      respond_to do |format|
        format.html { redirect_to stimulus_list_items_url, notice: 'List item was successfully destroyed.' }
